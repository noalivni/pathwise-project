  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="text-center">
        <h1 className="text-3xl font-bold text-slate-800">Choose Your Assessment</h1>
        <p className="text-slate-600 mt-2">Select the type of skills you'd like to evaluate</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <Card className="hover:shadow-lg transition-shadow cursor-pointer border-2 hover:border-teal-200">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl">Hard Skills Assessment</CardTitle>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <h4 className="font-semibold">What you'll assess:</h4>
        ...
        <Card className="hover:shadow-lg transition-shadow cursor-pointer border-2 hover:border-pink-200">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl">Soft Skills Assessment</CardTitle>
            <CardDescription className="text-lg">
