    ...
    <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              {isEditing ? (
                ...
                <p className="text-slate-800 mt-1">{profile.full_name || 'Not provided'}</p>
              )}
            </div>
            <div>
              <Label>Email</Label>
              <p className="text-slate-800 mt-1">{profile.email || 'Not provided'}</p>
            </div>
            <div>
              ...
              {isEditing ? (
                ...
                <p className="text-slate-800 mt-1">{profile.location || 'Not provided'}</p>
              )}
            </div>
          </div>
        </CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              {isEditing ? (
                ...
                <p className="text-slate-800 mt-1">{profile.degree_certification || 'Not provided'}</p>
              )}
            </div>
            <div>
              ...
              {isEditing ? (
                ...
                <p className="text-slate-800 mt-1">{profile.fields_of_study || 'Not provided'}</p>
              )}
            </div>
            <div>
              ...
              {isEditing ? (
                ...
                <p className="text-slate-800 mt-1">{profile.graduation_year || 'Not provided'}</p>
              )}
            </div>
          </div>
        </CardContent>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div>
            <Label htmlFor="career_history" className="flex items-center">
            ...
            {isEditing ? (
              ...
              <p className="text-slate-800 mt-1">{profile.career_history || 'Not provided'}</p>
            )}
          </div>
        </CardContent>
      </Card>
